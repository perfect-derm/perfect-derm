    ...
    <section class="container relative flex flex-row flex-wrap mb-8 md:mb-20 bg-fixed">
      ...
      <div class="w-full md:w-1/2 md:pl-20 flex flex-col flex-wrap">
        ...
        <c-single-square
          ...
          :link-title="$t('homepage__fourth_issue__link_title')"
        />
